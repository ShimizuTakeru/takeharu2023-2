function BMI710(){
  ...
  if(Number(y)/((Number(x)/100)*(Number(x)/100))<18.5);{
    alert('あなたのBMIは+'(Number(y)/((Number(x)/100)*(Number(x)/100)))'+です。この体重は「低体重」となります。');}
  else if(Number(y)/((Number(x)/100)*(Number(x)/100))<25);{
    alert('あなたのBMIは+'(Number(y)/((Number(x)/100)*(Number(x)/100)))'+です。この体重は「普通」となります。');}
  else if(Number(y)/((Number(x)/100)*(Number(x)/100))>=25);{
    alert('あなたのBMIは+'(Number(y)/((Number(x)/100)*(Number(x)/100)))'+です。この体重は「肥満」となります。');}
}
